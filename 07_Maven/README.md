...
del proyecto y nombre del artefacto:
	...
	Podriamos entenderlo como el nombre de la compañia que ha hecho el proyecto. Tiene formato de
	paquete en java.
...
Entre las carpetas y paquetes más importantes encontraermos:
	...
	objetos de nuestra aplicacion, un fichero .properties, un fichero de configuración, etc.
	...
	3.5) Maven dependecies, aqui podemos ver todos las librerías (.jar) que van a ser usadas en nuestro
	...
	de vida de nuestro proyecto, desde con que version de java trabajaremos, que librerías queremos
