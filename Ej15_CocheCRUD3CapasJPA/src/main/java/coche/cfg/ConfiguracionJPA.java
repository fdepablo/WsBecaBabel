...
@Configuration
@ComponentScan(basePackages = { "coche" })//buscamos anotaciones de Spring
...
public class ConfiguracionJPA {
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/jpa_coches?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
		ds.setUsername("root");
		ds.setPassword(""); 
		return ds;
	}
	...
	public LocalContainerEntityManagerFactoryBean 
		...
		entityManagerFactoryBean.setPackagesToScan("coche.modelo.entidad");
